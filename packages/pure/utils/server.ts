...
/** Group collections by their parent folder (category) based on the id path */
export function groupCollectionsByCategory<T extends CollectionKey>(
  collections: Collections
